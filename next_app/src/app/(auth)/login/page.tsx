    ...
    <main className="min-h-screen flex flex-col items-center justify-center p-6 bg-muted/20">
      ...
      <div className="w-full max-w-[400px] flex flex-col items-center">
        ...
        <div className="mb-10 text-center">
          ...
          <p className="text-sm text-muted-foreground">Sign in to your Enzira Begena portal.</p>
        </div>
          ...
          <form className="space-y-5">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                ...
                <Link href="#" className="text-[10px] text-primary font-bold hover:underline uppercase tracking-tighter">Forgot?</Link>
              </div>
              <div className="relative">
            ...
            <Button asChild className="w-full h-11 text-xs font-bold uppercase tracking-widest bg-primary hover:bg-primary/90 text-white shadow-lg shadow-primary/20 mt-2">
