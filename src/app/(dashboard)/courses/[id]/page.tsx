          ...
          <div className="lg:col-span-8 space-y-6">
            <div className="aspect-video bg-gradient-to-br from-primary/20 to-primary/5 rounded-lg overflow-hidden relative group border">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <Button size="icon" className="h-16 w-16 rounded-[5px] shadow-2xl scale-110 hover:scale-125 transition-transform bg-primary hover:bg-primary">
            ...
            <Tabs defaultValue="description" className="w-full">
              <div className="w-full overflow-x-auto pb-2 scrollbar-hide">
                <TabsList className="inline-flex w-max justify-start p-1 bg-muted/30 rounded-[5px] h-auto gap-1 border border-black/5 dark:border-white/5">
                  <TabsTrigger value="description" className="rounded-[5px] px-6 py-2.5 text-sm font-semibold data-[state=active]:bg-background data-[state=active]:shadow-sm data-[state=active]:text-primary transition-all duration-300">Description</TabsTrigger>
                  <TabsTrigger value="resources" className="rounded-[5px] px-6 py-2.5 text-sm font-semibold data-[state=active]:bg-background data-[state=active]:shadow-sm data-[state=active]:text-primary transition-all duration-300">Resources</TabsTrigger>
                  <TabsTrigger value="quiz" className="rounded-[5px] px-6 py-2.5 text-sm font-semibold data-[state=active]:bg-background data-[state=active]:shadow-sm data-[state=active]:text-primary transition-all duration-300">Knowledge Check</TabsTrigger>
                  <TabsTrigger value="discussion" className="rounded-[5px] px-6 py-2.5 text-sm font-semibold data-[state=active]:bg-background data-[state=active]:shadow-sm data-[state=active]:text-primary transition-all duration-300">Discussion</TabsTrigger>
                </TabsList>
              </div>
              ...
              <TabsContent value="resources" className="mt-8 animate-in fade-in slide-in-from-bottom-2 duration-500">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="group flex items-center gap-4 p-4 rounded-[5px] border border-black/5 dark:border-white/5 bg-gradient-to-br from-primary/5 to-transparent hover:shadow-[0_8px_24px_rgba(0,0,0,0.06)] hover:-translate-y-1 hover:border-primary/20 transition-all duration-300 cursor-pointer">
                    <div className="bg-background shadow-sm border border-black/5 p-3 rounded-[5px] group-hover:scale-110 transition-transform duration-300 text-primary">
