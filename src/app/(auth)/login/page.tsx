        ...
        <div className="hidden md:flex md:w-5/12 p-6 relative overflow-hidden bg-gradient-to-br from-primary via-primary/80 to-primary/40">
          ...
          <div className="relative z-10 flex flex-col h-full justify-between text-white">
            ...
            <div className="space-y-2">
              <p className="text-primary-foreground/80 text-[10px] font-medium uppercase tracking-wider">Welcome back</p>
        ...
        <div className="w-full md:w-7/12 p-4 sm:p-6 md:p-8 flex flex-col justify-center bg-background">
          <div className="w-full max-w-[300px] mx-auto">
            ...
            <div className="mb-5">
              ...
              <h1 className="text-lg font-bold tracking-tight mb-0.5">Welcome back</h1>
              ...
              <div className="space-y-1">
                ...
                <div className="relative">
                  <Input 
                    ...
                    required 
                  />
                  <Link href="#" className="absolute right-2.5 top-1/2 -translate-y-1/2 text-[9px] text-muted-foreground hover:text-primary font-medium">Forgot?</Link>
                </div>
              </div>
